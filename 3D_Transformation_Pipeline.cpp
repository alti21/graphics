...
#define UpperBD 7//changed from 5 //works with 4
#define PI  	3.1415926 
#define Num_pts 10
using namespace std;
float Xe = 200.0f;
...
world.X[4] = 60.0;  world.Y[4] = -50.0;  world.Z[4] = 0;  //NEWLINEADDED
world.X[5] = 60.0;  world.Y[5] = 50.0;  world.Z[5] = 0;//NEWLINEADDED
