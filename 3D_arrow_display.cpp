...
//glBegin(GL_LINES);
//
//     glVertex2f(viewer.X[46],viewer.Y[46]);
//     glVertex2f(viewer.X[47],viewer.Y[47]);
//glEnd();
...
//       
      ...
      glVertex2f(perspective.X[46],perspective.Y[46]);
        ...
        glVertex2f(perspective.X[52],perspective.Y[52]-0.055); 
      glVertex2f(perspective.X[46],perspective.Y[46]-0.055);
      
         glVertex2f(perspective.X[48],perspective.Y[48]-0.055); 
      glVertex2f(perspective.X[47],perspective.Y[47]-0.055);
      
      glVertex2f(perspective.X[49],perspective.Y[49]-0.055); 
      glVertex2f(perspective.X[50],perspective.Y[50]-0.055);
      
      glVertex2f(perspective.X[50],perspective.Y[50]-0.055); 
      glVertex2f(perspective.X[51],perspective.Y[51]-0.055);
...
////      
//       glVertex2f(perspective.X[60],perspective.Y[60]); 
//      glVertex2f(perspective.X[61],perspective.Y[61]);
